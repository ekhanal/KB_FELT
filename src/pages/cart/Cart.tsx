      ...
      <div className="p-2 flex flex-col md:flex md:flex-row mb-2 justify-between px-5 lg:px-20 w-full mt-3">
        <div className="w-full md:w-7/12">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex gap-2">
                          {cartItem?.stock?.attributes?.map((attr, index) => (
                            <div key={index}>
                              <div className="bg-black text-white border border-black text-xs px-2 py-1 font-medium rounded-lg cursor-pointer">
                                {getValue(attr, "value")}
                              </div>
                            </div>
                          ))}
          ...
          <div className="my-5 h-full flex flex-col w-96">
            <h2 className="text-sm font-semibold">Select Delivery Address</h2>
