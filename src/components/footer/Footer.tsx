  ...
  return (
    <>
      <div className="bg-white pt-20">
        <div className="flex justify-between py-10 bg-gray-100 px-5 md:px-20">
        ...
        <footer className="footer-color text-black px-5 md:px-20  py-5 md:pt-10 ">
          <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-7 gap-5 text-sm">
            ...
            <div className="col-span-2">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button className="py-2 px-3 bg-pink-400 text-white rounded-full text-base mt-2 font-semibold">
                    Subscribe
                  </button>
                </li>
              </ul>
          ...
          <div className="mt-5 border-t border-white pt-4 flex justify-between items-center">
            <p className="text-black text-sm">
              &copy; {new Date().getFullYear()} kb-felt All rights reserved.
            </p>
            <div>
              <div className="flex space-x-4 ">
                <a
                  href="/"
                  className="text-[#22787f] hover:text-pink-400 bg-white p-2 rounded-lg"
                >
                  <FaFacebook />
                </a>
                <a
